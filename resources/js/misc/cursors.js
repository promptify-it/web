...
export class Cursors {
  ...
  setTinyCursor() {
    ...
    for (const [, tinyCursor] of this.nodeCursors.entries()) {
  ...
  drawParticles() {
    let particles = `<g class="particles" filter=${this.filterParticles || 'none'}>`;
    ...
    particles += Array(this.nbrParticles)
      .fill()
      .map(
        (_, i) => `<circle
